...
public class MyPageController {
	 ...
	 * @return model : 데이터 전달용 객체(request scope)
	 */
	@GetMapping("info")
	public String info(
	...
	public String changePw(
		...
		// redirect 주소 : /myPage/info, /myPage/changePw (GET)
	 ...
	 * @param ra : redirect 시 request scope 데이터 전달
	...
	public String secession(
		...
		if(result > 0) {
			...
			path = "secession"; // 탈퇴 페이지 redirect
		}
