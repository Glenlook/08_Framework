package ehu.kh.demo.controller;
...
public class ParameterController {
	...
	public String paramMain() {
		// classpath:/templates/param/main/param-main.html로 forward하기
...
//@RequestMapping(value = "test1", method = RequestMethod.GET)
	...
	public String test1(HttpServletRequest req) {
		...
		// request scope에 K:"message", V:"메세지 입니다" 세팅
		req.setAttribute("message", "메세지 입니다");
	...
	public String test5(
	  ...
	  // -> key값과 변수명이 같을 경우 
		...
		// 지금은 생략하면 오류 발생!!!
			...
			/* @ModelAttribute */ Member member2 // == 커멘드 객체
		) {
